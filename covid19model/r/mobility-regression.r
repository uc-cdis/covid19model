...
forecast_googleMob <- function(codeToName, stateList) {
  ...
  task <- TaskRegr$new(
    id = "grocery.pharmacy", backend = as.data.frame(mobility_data %>%
  ...
  print("parks")
  task <- TaskRegr$new(
    id = "parks", backend = as.data.frame(mobility_data %>%
  ...
  task <- TaskRegr$new(
    id = "transitstations", backend = as.data.frame(mobility_data %>%
  ...
  print("workplace")
  task <- TaskRegr$new(
    id = "workplace", backend = as.data.frame(mobility_data %>%
  ...
  print("residential")
  task <- TaskRegr$new(
    id = "residential", backend = as.data.frame(mobility_data %>%
  ...
  print(df_raw_error %>% summarise(
    retail.recreation = mean(retail.recreation),
